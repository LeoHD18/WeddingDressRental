...
public class Main {
    ...
    private static void employeeMenu() {
        while (true) {
            ...
            System.out.println("4. Wash and Prep Dress");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    washAndPrepDress();  // Calling the wash and prep method
                    break;
                case 0:
    ...
    private static void washAndPrepDress() {
        System.out.print("Enter Dress ID to prepare: ");
        String dressId = scanner.nextLine();
        InventoryItem item = inventoryManager.findItemById(dressId);
        ...
        if (item instanceof Dress) {
            ...
            WashAndPrep washAndPrep = new WashAndPrep();
            // Perform the wash and prep operation regardless of current availability status
            employee.performWashAndPrep(dress, washAndPrep);
            System.out.println("Dress " + dress.getDressID() + " has been washed and prepped.");
            dress.setAvailable(true); // Set the dress to "Available" after washing/prepping
        } else {
            System.out.println("Item found is not a dress.");
        }
    }
