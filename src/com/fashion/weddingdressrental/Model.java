...
public class Model {
    ...
    public String toString() {
        return String.format("ID: %s | Name: %s | Age: %d | Gender: %s | Nationality: %s | Height: %.2f | Weight: %.2f | Bust: %.2f | Waist: %.2f | Hips: %.2f | DressSize: %s | Experience: %d years | Skills: %s | Price/Day: $%.2f",
